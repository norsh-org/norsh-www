...
const Ip = () => {
	return (
		<> 
			...
			<div className="bannerContainer" style={{ backgroundImage: `url(${t("cdn")}${t("img.ip.bannerBg")})` }}>
				...
				<div className="divContainer container-lg text-white">
					<div className="row m-4 align-items-center">
						<div className="col-12 col-md-8 mt-5 mt-md-0 text-center text-md-start">
							<h1 className="fs-0">{t("ip.banner.title")}</h1>
							<div className="mt-3 fs-4 fw-lighter">{decodeHtmlAndParse(t("ip.banner.subtitle"))}</div>
						</div>
					</div>
				</div>
				</div>
			...
			<div className="container-lg" style={{ marginBottom: 100, marginTop: 100 }}>
					<div className="row">
						...
						<div className="col-12 col-lg-7 pe-4">
							<h1 className="fs-0 mb-4">{decodeHtmlAndParse(t("ip.whatIs.title"))}</h1>
							<p className="fs-5 fw-lighter">
								{decodeHtmlAndParse(t("ip.whatIs.text"))}
								{decodeHtmlAndParse(t("ip.whatIs.list"))}
							</p>
						</div>
					</div>
				</div>
				...
				<div className="container-lg" style={{ marginTop: 100, marginBottom: 200 }}>
                    <FaqAccordion faqPath="ip.faq.items" />
                </div>
		</>
	);
};
